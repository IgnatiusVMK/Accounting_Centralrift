                              ...
                              <div class="modal-body">
                                ...
                                <svg class="text-dark" width="16px" height="16px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> 
                                  ...
                                  <form  method="post" action="modify-users.php">
                                      ...
                                      <input class="input-user"  type="text" name="name" placeholder="Name" value="<?= $row['role']?>">
...
<!-- 
                      ...
                      <td class="align-middle ">
                        <a href="./db_updates/delete-users.php?id=<?= $row['id']; ?>" class=" ni ni-fat-delete  text-danger text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
