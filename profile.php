...
<body class="g-sidenav-show bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" #/soft-ui-dashboard/pages/dashboard.php " target="_blank">
      ...
      <div class="row">
        ...
        <div class="col-12 col-xl-4">
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              <p class="text-sm">
                Hi, <?php echo $_SESSION['name']?> , Decisions: If you can’t decide, the answer is no. If two equally difficult paths, choose the one more painful in the short term (pain avoidance is creating an illusion of equality).
              </p>
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; <?php echo $_SESSION['name']?></li>
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong> &nbsp; <?php echo $_SESSION['name']?></li>
        ...
        <div class="col-12 mt-4">
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              ...
              <p class="text-sm">Agricultural Farm Products</p>
            </div>
            <!-- <div class="card-body p-3">
              <div class="row">
