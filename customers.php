        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="col-11 p-2 text-end ">
                <button type="button" class="btn btn-block bg-gradient-danger mb-3" data-bs-toggle="modal" data-bs-target="#modal-default">+  Add Customer</button>
                <div class="modal fade" id="modal-default" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="modal-title-default">Add Customer Details</h6>
                                <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                                </button>
                            </div>
                            <div class="modal-body">
                              <!-- <img src="assets/img/marley.png" alt="logo" class="text-center"> -->
                                
                                <form  method="post" action="db_updates/add-customer.php">

                                <input class="input-user"  type="text" name="name" placeholder="CustomerName">

                                <input class="input-user"  type="email" name="email" placeholder="Email">

                                <input class="input-user"  type="number" name="contact" placeholder="Contact">
                                
                                <input class="input-user"  type="text" name="address" placeholder="Address">
                  ...
                  <tbody>
                    <?php 
                      ...
                      <td class="align-middle">
                        <a href="edit-customers.php?CustomerId=<?= $row['Customer_Id']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                      </td>
                      <!-- <td class="align-middle ">
                        <a href="db_updates/delete-customer.php?CustomerId=<?= $row['CustomerId']; ?>" class=" ni ni-fat-delete  text-danger text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        </a>
                      </td> -->
                    </tr>
                    <?php }?>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <?php 
                      require 'db_conn.php';
                      $sales="SELECT sales.Sales_Id, Sales.Customer_Id, Sales.Sale_Date, Sales.Quantity, Sales.Total_Price, Sales.Payment_Method ,Sales.Payment_Status
                      FROM sales";
