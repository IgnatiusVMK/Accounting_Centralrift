        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <p> <b>Suppliers table</b></p>
            </div>
            <div class="col-11 p-2 text-end ">
                <button type="button" class="btn btn-block bg-gradient-danger mb-3" data-bs-toggle="modal" data-bs-target="#modal-default">+ New Supplier</button>
                <div class="modal fade" id="modal-default" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="modal-title-default">Add Suppliers Details</h6>
                            ...
                            <div class="modal-body">
                                ...
                                <form  method="post" action="db_updates/add-product.php">
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php 
                      require 'db_conn.php';
                      $products="SELECT suppliers.Supplier_Id, suppliers.Supplier_Name, suppliers.Contact_Name, suppliers.Address, suppliers.Phone, suppliers.Contact_Name, suppliers.Email, suppliers.Created_Date
                      FROM suppliers
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?= $row['Supplier_Name']?></h6>
                            <p class="text-xs text-secondary mb-0"><?= $row['Supplier_Id']?></p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><b><?= $row['Contact_Name']?></b></p>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><b><?= $row['Address']?></b></p>
                        <p class="text-xs font-weight-bold mb-0">+254 <?= $row['Phone']?></p>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        <p class="text-xs text-secondary mb-0"><?= $row['Created_Date']?></p>
                      </td>
